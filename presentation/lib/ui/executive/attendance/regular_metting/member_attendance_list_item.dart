...
class MemberAttendanceListItem extends StatelessWidget {
  const MemberAttendanceListItem({super.key, required this.data});
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text(
                      data.firstAttendanceCheckTime?.format("hh시 mm분 ss초") ??
                          "-",
                      style: TextStyle(
                        fontSize: 10,
                        fontWeight: FontWeight.w700,
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text(
                      data.secondAttendanceCheckTime?.format("hh시 mm분 ss초") ??
                          "-",
                      style: TextStyle(
                        fontSize: 10,
                        fontWeight: FontWeight.w700,
