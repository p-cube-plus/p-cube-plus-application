...
class CalendarSelectedDateSummaryView extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    ...
    return watchWidget(
      ...
      (currentDate) {
        final scheduleList = read(context).monthSchedule[currentDate.day];
        if (scheduleList?.isEmpty ?? true) return const SizedBox();
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  color: scheduleData.scheduleColor),
                            ),
                            const SizedBox(width: 16.0),
                            Text(
                              scheduleData.startTime.format("a hh:mm"),
                              style: TextStyle(
                                fontSize: 10,
                                fontWeight: FontWeight.w400,
                                color: theme.neutral60,
